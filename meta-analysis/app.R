...
library(shiny);library(rhandsontable);library(magrittr);library(meta);library(shinycustomloader);library(colourpicker)
...
server <- function(input, output, session) {
    ...
    output$drapery <- renderPlot({
      ...
      drapery(obj.meta(), 
              ...
              pos.legen = input$legendposition_drapery, prediction = pred)
    })
